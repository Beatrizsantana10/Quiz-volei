...
export default function Login() {
    ...
    const perguntas = [
        {
            texto: 'Qual é a altura oficial da rede de vôlei feminina?',
            opcoes: [
                { texto: 'A) 150 cm', respostaCorreta: false },
                { texto: 'B) 233 cm', respostaCorreta: false },
                { texto: 'C) 224 cm', respostaCorreta: true },
                { texto: 'D) 330 cm', respostaCorreta: false },
            ],
        },
        {
        ...
        {
            texto: 'Quantas posições (quantidade de jogadores) tem em um time?',
            opcoes: [
                { texto: 'A) 5', respostaCorreta: false },
                { texto: 'B) 6', respostaCorreta: true },
                { texto: 'C) 7', respostaCorreta: false },
                { texto: 'D) 8', respostaCorreta: false },
            ],
        },
        {
            texto: 'Qual é a pontuação máxima que uma equipe pode alcançar em um set de vôlei tradicional?',
            opcoes: [
